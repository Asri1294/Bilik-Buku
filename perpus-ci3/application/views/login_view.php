...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/buku/mini.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">Perpustakaan Digital<br/><b>Bilik Buku</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #226bbf; border-radius: 20px;">
  ...
  <br/>
  <footer>
    <div class="login-box-body text-center bg-blue" style="border-radius: 20px;">
       <a style="color: white;"> Copyright &copy; Perpustakaan Digital Codekop - Modified by Bilik Buku <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
